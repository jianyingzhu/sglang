...
class ForwardBatch(ForwardBatchDeepSeekMHAMixin):
    ...
    def init_new(
        ...
        ret = cls(
            ...
            num_verify_reqs=getattr(batch, 'num_verify_reqs', 0),
            num_verify_tokens=getattr(batch, 'num_verify_tokens', 0),
            verify_spec_info=getattr(batch, 'verify_spec_info', None),
